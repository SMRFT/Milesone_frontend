      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            {Object.values(counts.doctorReferral).reduce((sum, count) => sum + count, 0)}
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            {Object.values(counts.others).reduce((sum, count) => sum + count, 0)}
          </div>
        </div>
      </div>
...
{Object.keys(counts.doctorReferral).length > 0 && (
  <div style={{
    ...
    <ul style={{
      ...
      {Object.entries(counts.doctorReferral).map(([doctor, count]) => (
        <li key={doctor} style={{
      ...
      <tbody>
        {registrations.map((reg, index) => (
          ...
          >
            ...
            <td style={{ padding: '10px 15px' }}>{reg.registration_number}</td>
  ...
  {(() => {
    try {
      ...
      return reg.reason_for_visit || 'N/A';
            ...
            <td style={{ padding: '10px 15px', maxWidth: '200px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
