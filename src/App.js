    ...
    <>
      ...
      <ContentWrapper>
        <Routes>
          ...
          <Route path="ReferralDoctorRegister" element={<ReferralDoctorRegister />} /> 

          <Route path="/PatientCardView/:type" element={<PatientCardView />} />
          ...
          <Route path="/PediatricAssessmentForm" element={<PediatricAssessmentForm />} />
          {/* <Route path="/PediatricAssessmentReport" element={<PediatricAssessmentReport/>} /> */}                   

          <Route path='/WeightGraphForBoys' element={<WeightGraphForBoys/>} />
          <Route path="/HeightGraphForBoys" element={<HeightGraphForBoys/>} />
          <Route path="/HeightGraphForGirls" element={<HeightGraphForGirls/>} />
          <Route path="/WeightGraphForGirls" element={<WeightGraphForGirls/>} />
          
          <Route path="/TherapyBilling" element={<TherapyBilling/>} />
          <Route path="/Therapybillingview" element={<Therapybillingview/>} />
          ...
          <Route path="FetchChildAssessment" element={<FetchChildAssessment/>} />  
          <Route path="ChildLanguageAssessment" element={<ChildLanguageAssessment/>} />  
          <Route path="ChildLanguageReport" element={<ChildLanguageReport />} />  

          <Route path="/FetchDevelopmentkids" element={<FetchDevelopmentkids />} />
          <Route path="/DevelopmentalScreening" element={<DevelopmentalScreening />} />
          <Route path="FetchDevelopmentScreeningReport" element={<FetchDevelopmentScreeningReport />} />  
          <Route path="DevelopmentScreeningReport" element={<DevelopmentScreeningReport />} />   

          <Route path="FetchCBCL" element={<FetchCBCL />} /> 
          <Route path="CBCLforGirls6To18y" element={<CBCLforGirls6To18y />} />  
          <Route path="FetchCBCLforGirls6To18yReports" element={<FetchCBCLforGirls6To18yReports />} />  
          <Route path="CBCLforGirls6To18yReports" element={<CBCLforGirls6To18yReports />} />        
